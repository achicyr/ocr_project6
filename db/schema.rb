...
ActiveRecord::Schema.define(version: 2020_07_30_152535) do
  ...
  create_table "users_activities", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "users_activity_log_id"
    t.index ["activity_id"], name: "index_users_activities_on_activity_id"
    t.index ["user_id"], name: "index_users_activities_on_user_id"
    t.index ["users_activity_log_id"], name: "index_users_activities_on_users_activity_log_id"
  end

  create_table "users_activity_logs", force: :cascade do |t|
    t.integer "howlong"
    t.string "performances"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  add_foreign_key "users_activities", "users_activity_logs"
end
